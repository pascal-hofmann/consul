...
func newControllerRunner(c *Controller, watchClient pbresource.ResourceServiceClient, runtimeClient pbresource.ResourceServiceClient, defaultLogger hclog.Logger) *controllerRunner {
